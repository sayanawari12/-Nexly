...
export const SEARCH_INDEX_DATABASE = [
  ...
  { id: 'dl-c-cheat', title: 'C Language Pointers Cheat Sheet (PDF)', desc: 'Quick 2-page visual PDF guide for memory layout & pointer rules.', category: '📥 Downloads', type: 'download', path: '/curriculum/semester-2/data-structures/notes', keywords: ['cheat sheet', 'c cheat sheet', 'pdf notes', 'pointers cheat sheet'] },
  { id: 'dl-lab-manual', title: 'BCA Semester 1 & 2 Official Lab Manual', desc: 'Complete verified lab codes with output snapshots for end-sem exams.', category: '📥 Downloads', type: 'download', path: '/curriculum/semester-2/data-structures/notes', keywords: ['lab manual', 'bca lab manual', 'practical codes', 'exam lab'] },
  { id: 'dl-pyq-archive', title: 'University PYQ Question Papers (2020–2025)', desc: 'Zip archive containing last 5 years solved university examination papers.', category: '📥 Downloads', type: 'download', path: '/curriculum/semester-2/data-structures/notes', keywords: ['pyq', 'question papers', 'past papers', 'exam papers', 'solved pyq'] },
  { id: 'dl-knr-book', title: 'The C Programming Language (K&R PDF)', desc: 'Classic Dennis Ritchie & Brian Kernighan official reference textbook.', category: '📥 Downloads', type: 'download', path: '/curriculum/semester-2/data-structures/notes', keywords: ['k&r', 'ritchie', 'c book', 'reference book', 'textbook pdf'] },
