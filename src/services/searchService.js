...
export const SEARCH_INDEX_DATABASE = [
  ...
  // ── 📚 SUBJECTS & CURRICULUM ──
  { id: 'subj-c-sem1', title: 'Problem Solving Using C (BCA-101)', desc: 'Semester 1 mandatory foundational programming course.', category: '📚 Subjects', type: 'subject', path: '/subjects/c-programming', keywords: ['bca-101', 'c subject', 'semester 1', 'problem solving', 'first semester'] },
  { id: 'subj-co-sem1', title: 'Computer Architecture & Assembly (BCA-102)', desc: 'CPU logic gates, ALU, memory hierarchy, and machine instruction sets.', category: '📚 Subjects', type: 'subject', path: '/subjects/computer-architecture', keywords: ['bca-102', 'computer architecture', 'co', 'alu', 'cpu', 'registers', 'assembly'] },
  { id: 'subj-os-sem2', title: 'Operating Systems & Kernel (BCA-201)', desc: 'Process scheduling, deadlocks, paging virtual memory, and file systems.', category: '📚 Subjects', type: 'subject', path: '/subjects/operating-system', keywords: ['bca-201', 'os', 'operating system', 'kernel', 'deadlock', 'paging', 'virtual memory', 'processes'] },
  { id: 'subj-dbms-sem2', title: 'Database Management Systems (BCA-202)', desc: 'Relational model, SQL queries, normalization, ACID properties, and indexing.', category: '📚 Subjects', type: 'subject', path: '/subjects/dbms', keywords: ['bca-202', 'dbms', 'sql', 'database', 'queries', 'normalization', 'transactions', 'keys'] },
  { id: 'subj-dsa-sem3', title: 'Data Structures & Algorithms (BCA-301)', desc: 'Stacks, queues, linked lists, trees, graphs, sorting, and time complexity.', category: '📚 Subjects', type: 'subject', path: '/subjects/data-structures', keywords: ['bca-301', 'dsa', 'data structures', 'algorithms', 'trees', 'graphs', 'stacks', 'queues'] },
