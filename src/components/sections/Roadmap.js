...
const Roadmap = () => {
  ...
  return (
    <section id="roadmap" className="roadmap-apple-section">
      ...
      >
        <h2 className="roadmap-apple-title">Learning Roadmaps</h2>
      ...
      >
        ...
        <motion.div className="roadmap-apple-card" variants={cardVariants}>
          <div className="roadmap-card-header">
            <h3 className="roadmap-card-title">💻 Programming Languages</h3>
        ...
        <motion.div className="roadmap-apple-card" variants={cardVariants}>
          <div className="roadmap-card-header">
            <h3 className="roadmap-card-title">🌐 Web Development</h3>
            <p className="roadmap-card-desc">
        ...
        <motion.div className="roadmap-apple-card" variants={cardVariants}>
          <div className="roadmap-card-header">
            <h3 className="roadmap-card-title">🧩 Data Structures & Algorithms</h3>
            <p className="roadmap-card-desc">
