      ...
      <div className="footer-content">
        <div className="footer-brand">
          <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Code2 size={24} color="var(--primary-purple)" />
            BCA <span style={{ color: 'var(--accent-glow)', fontSize: '0.8rem', background: 'rgba(192, 132, 252, 0.1)', padding: '2px 8px', borderRadius: '4px', border: '1px solid rgba(192, 132, 252, 0.2)' }}>DEPT</span>
          </h2>
          <p>Shaping future developers and tech leaders through premium technical training and research excellence.</p>
          <div className="footer-socials">
            {/* Github Inline SVG */}
            <a href="https://github.com" className="footer-social-icon" aria-label="GitHub">
