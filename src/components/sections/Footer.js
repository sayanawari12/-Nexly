...
const GitHubIcon = () => (
  /* GitHub official mark — filled monochrome */
  <svg
    width="20" height="20"
    viewBox="0 0 98 96"
    fill="currentColor"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756
      ...
      4.934.326 7.523 5.052 7.523 5.052 4.367 7.496 11.404
      5.378 14.235 4.074.404-3.178 1.699-5.378
      3.074-6.6-10.839-1.141-22.243-5.378-22.243-24.283
      0-5.378 1.94-9.778 5.014-13.2-.485-1.222-2.184-6.275.486-13.038
      0 0 4.125-1.304 13.426 5.052a46.97 46.97 0 0 1
      12.214-1.63c4.125 0 8.33.571 12.213 1.63
      9.302-6.356 13.427-5.052 13.427-5.052 2.67
      6.763.97 11.816.485 13.038 3.155 3.422
      5.015 7.822 5.015 13.2 0 18.905-11.404
      23.06-22.324 24.283 1.78 1.548 3.316
      4.481 3.316 9.126 0 6.6-.08 11.897-.08
      13.526 0 1.304.89 2.853 3.316 2.364
      19.412-6.52 33.405-24.935
...
const LinkedInIcon = () => (
  /* LinkedIn official "in" mark — filled */
  <svg
    width="20" height="20"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853
      ...
      13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0
...
const InstagramIcon = () => (
  /* Instagram official camera mark — filled */
  <svg
    width="20" height="20"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148
      ...
      4.849 0 3.205-.012 3.584-.069 4.849-.149
      ...
      6.98C8.333 23.986 8.741 24 12 24c3.259
...
const SOCIAL_LINKS = [
  {
    ...
    ariaLabel: 'Visit GitHub Profile of Sayan Awari',
  ...
  },
  {
    ...
    ariaLabel: 'Visit LinkedIn Profile of Sayan Awari',
    accentColor: '#0a66c2',
  },
  {
    name: 'Instagram',
    ...
    ariaLabel: 'Visit Instagram Profile of Sayan Awari',
    accentColor: '#e1306c',
  },
];
